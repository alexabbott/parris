...
function twentysixteen_scripts() {
	...
	// Add hover.css
	wp_enqueue_style( 'hover', get_template_directory_uri() . '/css/hover.css', array(), '3.4.1' );
	...
	wp_enqueue_script( 'twentysixteen-angular-script', get_template_directory_uri() . '/js/angular.min.js', array( 'jquery' ), '20160703', true );

	wp_enqueue_script( 'twentysixteen-custom-script', get_template_directory_uri() . '/js/app.js', array( 'jquery' ), '20160703', true );
